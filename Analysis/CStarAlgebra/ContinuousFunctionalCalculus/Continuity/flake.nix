...
{
  description = "Mathlib module: Analysis.CStarAlgebra.ContinuousFunctionalCalculus.Continuity";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Analysis.CStarAlgebra.ContinuousFunctionalCalculus.Continuity";
        version = "0.1.0";
        src = ./.;
