...
{
  description = "Mathlib module: Analysis.SpecialFunctions.Integrability.LogMeromorphic";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Analysis.SpecialFunctions.Integrability.LogMeromorphic";
        version = "0.1.0";
        src = ./.;
