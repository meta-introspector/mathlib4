...
{
  description = "Mathlib module: Analysis.SpecialFunctions.Integrals.LogTrigonometric";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Analysis.SpecialFunctions.Integrals.LogTrigonometric";
        version = "0.1.0";
        src = ./.;
