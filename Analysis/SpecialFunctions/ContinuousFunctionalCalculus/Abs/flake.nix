...
{
  description = "Mathlib module: Analysis.SpecialFunctions.ContinuousFunctionalCalculus.Abs";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Analysis.SpecialFunctions.ContinuousFunctionalCalculus.Abs";
        version = "0.1.0";
        src = ./.;
