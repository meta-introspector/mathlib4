...
{
  description = "Mathlib module: Analysis.NormedSpace.PiTensorProduct.ProjectiveSeminorm";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Analysis.NormedSpace.PiTensorProduct.ProjectiveSeminorm";
        version = "0.1.0";
        src = ./.;
