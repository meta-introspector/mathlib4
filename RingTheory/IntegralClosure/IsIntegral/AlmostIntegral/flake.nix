...
{
  description = "Mathlib module: RingTheory.IntegralClosure.IsIntegral.AlmostIntegral";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-RingTheory.IntegralClosure.IsIntegral.AlmostIntegral";
        version = "0.1.0";
        src = ./.;
