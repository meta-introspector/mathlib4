...
{
  description = "Mathlib module: Geometry.Euclidean.Angle.Unoriented.TriangleInequality";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Geometry.Euclidean.Angle.Unoriented.TriangleInequality";
        version = "0.1.0";
        src = ./.;
