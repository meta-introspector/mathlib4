...
{
  description = "Mathlib module: Geometry.RingedSpace.LocallyRingedSpace.ResidueField";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Geometry.RingedSpace.LocallyRingedSpace.ResidueField";
        version = "0.1.0";
        src = ./.;
