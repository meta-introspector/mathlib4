...
{
  description = "Mathlib module: NumberTheory.ModularForms.EisensteinSeries.IsBoundedAtImInfty";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-NumberTheory.ModularForms.EisensteinSeries.IsBoundedAtImInfty";
        version = "0.1.0";
        src = ./.;
