...
{
  description = "Mathlib module: NumberTheory.ModularForms.EisensteinSeries.UniformConvergence";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-NumberTheory.ModularForms.EisensteinSeries.UniformConvergence";
        version = "0.1.0";
        src = ./.;
