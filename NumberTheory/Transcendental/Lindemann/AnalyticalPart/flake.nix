...
{
  description = "Mathlib module: NumberTheory.Transcendental.Lindemann.AnalyticalPart";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-NumberTheory.Transcendental.Lindemann.AnalyticalPart";
        version = "0.1.0";
        src = ./.;
