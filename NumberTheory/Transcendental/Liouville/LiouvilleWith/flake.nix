...
{
  description = "Mathlib module: NumberTheory.Transcendental.Liouville.LiouvilleWith";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-NumberTheory.Transcendental.Liouville.LiouvilleWith";
        version = "0.1.0";
        src = ./.;
