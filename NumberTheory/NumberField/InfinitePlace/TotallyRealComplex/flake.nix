...
{
  description = "Mathlib module: NumberTheory.NumberField.InfinitePlace.TotallyRealComplex";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-NumberTheory.NumberField.InfinitePlace.TotallyRealComplex";
        version = "0.1.0";
        src = ./.;
