...
{
  description = "Mathlib module: Topology.Algebra.Nonarchimedean.TotallyDisconnected";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Topology.Algebra.Nonarchimedean.TotallyDisconnected";
        version = "0.1.0";
        src = ./.;
