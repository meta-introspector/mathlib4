...
{
  description = "Mathlib module: AlgebraicGeometry.EllipticCurve.DivisionPolynomial.Degree";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-AlgebraicGeometry.EllipticCurve.DivisionPolynomial.Degree";
        version = "0.1.0";
        src = ./.;
