...
{
  description = "Mathlib module: AlgebraicGeometry.ProjectiveSpectrum.StructureSheaf";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-AlgebraicGeometry.ProjectiveSpectrum.StructureSheaf";
        version = "0.1.0";
        src = ./.;
