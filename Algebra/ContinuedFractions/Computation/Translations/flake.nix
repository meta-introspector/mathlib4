...
{
  description = "Mathlib module: Algebra.ContinuedFractions.Computation.Translations";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Algebra.ContinuedFractions.Computation.Translations";
        version = "0.1.0";
        src = ./.;
