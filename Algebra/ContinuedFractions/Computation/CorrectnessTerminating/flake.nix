...
{
  description = "Mathlib module: Algebra.ContinuedFractions.Computation.CorrectnessTerminating";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Algebra.ContinuedFractions.Computation.CorrectnessTerminating";
        version = "0.1.0";
        src = ./.;
