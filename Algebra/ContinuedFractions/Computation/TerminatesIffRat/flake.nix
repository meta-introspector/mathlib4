...
{
  description = "Mathlib module: Algebra.ContinuedFractions.Computation.TerminatesIffRat";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Algebra.ContinuedFractions.Computation.TerminatesIffRat";
        version = "0.1.0";
        src = ./.;
