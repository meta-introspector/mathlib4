...
{
  description = "Mathlib module: Algebra.Homology.HomotopyCategory.HomComplexInduction";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Algebra.Homology.HomotopyCategory.HomComplexInduction";
        version = "0.1.0";
        src = ./.;
