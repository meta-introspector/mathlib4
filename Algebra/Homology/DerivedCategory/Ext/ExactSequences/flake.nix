...
{
  description = "Mathlib module: Algebra.Homology.DerivedCategory.Ext.ExactSequences";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Algebra.Homology.DerivedCategory.Ext.ExactSequences";
        version = "0.1.0";
        src = ./.;
