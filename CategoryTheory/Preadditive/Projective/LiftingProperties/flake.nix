...
{
  description = "Mathlib module: CategoryTheory.Preadditive.Projective.LiftingProperties";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Preadditive.Projective.LiftingProperties";
        version = "0.1.0";
        src = ./.;
