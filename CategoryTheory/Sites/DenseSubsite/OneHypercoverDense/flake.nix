...
{
  description = "Mathlib module: CategoryTheory.Sites.DenseSubsite.OneHypercoverDense";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Sites.DenseSubsite.OneHypercoverDense";
        version = "0.1.0";
        src = ./.;
