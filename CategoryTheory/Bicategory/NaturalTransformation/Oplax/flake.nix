...
{
  description = "Mathlib module: CategoryTheory.Bicategory.NaturalTransformation.Oplax";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Bicategory.NaturalTransformation.Oplax";
        version = "0.1.0";
        src = ./.;
