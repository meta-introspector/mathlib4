...
{
  description = "Mathlib module: CategoryTheory.Bicategory.Functor.StrictPseudofunctor";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Bicategory.Functor.StrictPseudofunctor";
        version = "0.1.0";
        src = ./.;
