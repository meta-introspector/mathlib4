...
{
  description = "Mathlib module: CategoryTheory.Localization.CalculusOfFractions.Fractions";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Localization.CalculusOfFractions.Fractions";
        version = "0.1.0";
        src = ./.;
