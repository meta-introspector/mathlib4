...
{
  description = "Mathlib module: CategoryTheory.Localization.CalculusOfFractions.Preadditive";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Localization.CalculusOfFractions.Preadditive";
        version = "0.1.0";
        src = ./.;
