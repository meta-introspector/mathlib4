...
{
  description = "Mathlib module: CategoryTheory.Localization.DerivabilityStructure.PointwiseRightDerived";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Localization.DerivabilityStructure.PointwiseRightDerived";
        version = "0.1.0";
        src = ./.;
