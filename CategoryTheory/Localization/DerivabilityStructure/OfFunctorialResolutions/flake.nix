...
{
  description = "Mathlib module: CategoryTheory.Localization.DerivabilityStructure.OfFunctorialResolutions";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Localization.DerivabilityStructure.OfFunctorialResolutions";
        version = "0.1.0";
        src = ./.;
