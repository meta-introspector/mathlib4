...
{
  description = "Mathlib module: CategoryTheory.SmallObject.Iteration.FunctorOfCocone";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.SmallObject.Iteration.FunctorOfCocone";
        version = "0.1.0";
        src = ./.;
