...
{
  description = "Mathlib module: CategoryTheory.Limits.Shapes.Pullback.IsPullback.Basic";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Limits.Shapes.Pullback.IsPullback.Basic";
        version = "0.1.0";
        src = ./.;
