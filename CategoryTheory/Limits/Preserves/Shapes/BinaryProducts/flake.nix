...
{
  description = "Mathlib module: CategoryTheory.Limits.Preserves.Shapes.BinaryProducts";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Limits.Preserves.Shapes.BinaryProducts";
        version = "0.1.0";
        src = ./.;
