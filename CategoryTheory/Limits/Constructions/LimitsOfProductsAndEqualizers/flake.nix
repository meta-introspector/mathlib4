...
{
  description = "Mathlib module: CategoryTheory.Limits.Constructions.LimitsOfProductsAndEqualizers";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Limits.Constructions.LimitsOfProductsAndEqualizers";
        version = "0.1.0";
        src = ./.;
