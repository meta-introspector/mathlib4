...
{
  description = "Mathlib module: CategoryTheory.Limits.FunctorCategory.Shapes.Pullbacks";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Limits.FunctorCategory.Shapes.Pullbacks";
        version = "0.1.0";
        src = ./.;
