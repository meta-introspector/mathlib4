...
{
  description = "Mathlib module: CategoryTheory.Abelian.GrothendieckCategory.Coseparator";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-CategoryTheory.Abelian.GrothendieckCategory.Coseparator";
        version = "0.1.0";
        src = ./.;
