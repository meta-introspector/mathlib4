...
{
  description = "Mathlib module: Probability.Distributions.Gaussian.HasGaussianLaw.Independence";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Probability.Distributions.Gaussian.HasGaussianLaw.Independence";
        version = "0.1.0";
        src = ./.;
