...
{
  description = "Mathlib module: Combinatorics.SimpleGraph.Connectivity.EdgeConnectivity";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-Combinatorics.SimpleGraph.Connectivity.EdgeConnectivity";
        version = "0.1.0";
        src = ./.;
