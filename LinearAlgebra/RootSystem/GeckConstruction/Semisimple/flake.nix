...
{
  description = "Mathlib module: LinearAlgebra.RootSystem.GeckConstruction.Semisimple";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-LinearAlgebra.RootSystem.GeckConstruction.Semisimple";
        version = "0.1.0";
        src = ./.;
