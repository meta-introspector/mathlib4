...
{
  description = "Mathlib module: AlgebraicTopology.SimplicialSet.AnodyneExtensions.Rank";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-AlgebraicTopology.SimplicialSet.AnodyneExtensions.Rank";
        version = "0.1.0";
        src = ./.;
