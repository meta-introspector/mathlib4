...
{
  description = "Mathlib module: AlgebraicTopology.FundamentalGroupoid.SimplyConnected";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-AlgebraicTopology.FundamentalGroupoid.SimplyConnected";
        version = "0.1.0";
        src = ./.;
