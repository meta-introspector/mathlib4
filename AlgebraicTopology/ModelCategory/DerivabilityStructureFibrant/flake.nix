...
{
  description = "Mathlib module: AlgebraicTopology.ModelCategory.DerivabilityStructureFibrant";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-AlgebraicTopology.ModelCategory.DerivabilityStructureFibrant";
        version = "0.1.0";
        src = ./.;
