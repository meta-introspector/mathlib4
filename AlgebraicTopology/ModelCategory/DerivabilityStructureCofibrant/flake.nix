...
{
  description = "Mathlib module: AlgebraicTopology.ModelCategory.DerivabilityStructureCofibrant";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-AlgebraicTopology.ModelCategory.DerivabilityStructureCofibrant";
        version = "0.1.0";
        src = ./.;
