...
{
  description = "Mathlib module: AlgebraicTopology.ModelCategory.FibrantObjectHomotopy";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-AlgebraicTopology.ModelCategory.FibrantObjectHomotopy";
        version = "0.1.0";
        src = ./.;
