...
{
  description = "Mathlib module: MeasureTheory.Function.LpSpace.ContinuousCompMeasurePreserving";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-MeasureTheory.Function.LpSpace.ContinuousCompMeasurePreserving";
        version = "0.1.0";
        src = ./.;
