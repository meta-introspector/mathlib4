...
{
  description = "Mathlib module: MeasureTheory.Function.ConditionalExpectation.Indicator";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-MeasureTheory.Function.ConditionalExpectation.Indicator";
        version = "0.1.0";
        src = ./.;
