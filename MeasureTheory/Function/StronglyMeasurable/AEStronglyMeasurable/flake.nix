...
{
  description = "Mathlib module: MeasureTheory.Function.StronglyMeasurable.AEStronglyMeasurable";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-MeasureTheory.Function.StronglyMeasurable.AEStronglyMeasurable";
        version = "0.1.0";
        src = ./.;
