...
{
  description = "Mathlib module: MeasureTheory.Integral.Lebesgue.DominatedConvergence";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-MeasureTheory.Integral.Lebesgue.DominatedConvergence";
        version = "0.1.0";
        src = ./.;
