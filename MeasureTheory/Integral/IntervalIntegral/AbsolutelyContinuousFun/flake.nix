...
{
  description = "Mathlib module: MeasureTheory.Integral.IntervalIntegral.AbsolutelyContinuousFun";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-MeasureTheory.Integral.IntervalIntegral.AbsolutelyContinuousFun";
        version = "0.1.0";
        src = ./.;
