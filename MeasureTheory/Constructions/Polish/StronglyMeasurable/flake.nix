...
{
  description = "Mathlib module: MeasureTheory.Constructions.Polish.StronglyMeasurable";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-MeasureTheory.Constructions.Polish.StronglyMeasurable";
        version = "0.1.0";
        src = ./.;
