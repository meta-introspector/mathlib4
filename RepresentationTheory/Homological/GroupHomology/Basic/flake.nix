...
{
  description = "Mathlib module: RepresentationTheory.Homological.GroupHomology.Basic";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-RepresentationTheory.Homological.GroupHomology.Basic";
        version = "0.1.0";
        src = ./.;
