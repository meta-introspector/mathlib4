...
{
  description = "Mathlib module: RepresentationTheory.Homological.GroupHomology.LowDegree";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-RepresentationTheory.Homological.GroupHomology.LowDegree";
        version = "0.1.0";
        src = ./.;
