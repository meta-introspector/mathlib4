...
{
  description = "Mathlib module: RepresentationTheory.Homological.GroupCohomology.Functoriality";
  inputs = {
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    in
    {
      packages.${system}.default = pkgs.stdenv.mkDerivation {
        pname = "mathlib-module-RepresentationTheory.Homological.GroupCohomology.Functoriality";
        version = "0.1.0";
        src = ./.;
